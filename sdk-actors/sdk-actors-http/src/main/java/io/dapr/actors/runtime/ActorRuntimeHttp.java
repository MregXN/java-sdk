 ...
 */
public class ActorRuntimeHttp extends AbstractActorRuntime {
   ...
   */
  private ActorRuntimeHttp() throws IllegalStateException {
    this(buildDaprClient());
  }
   ...
   */
  private ActorRuntimeHttp(DaprClient daprClient) throws IllegalStateException {
