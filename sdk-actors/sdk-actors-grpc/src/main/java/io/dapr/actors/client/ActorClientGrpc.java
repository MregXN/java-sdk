 ...
 */
public class ActorClientGrpc extends AbstractActorClient {
   ...
   */
  private ActorClientGrpc(DaprApiProtocol apiProtocol) {
   ...
   * @param apiProtocol    Dapr's API protocol.
   */
  private ActorClientGrpc(DaprApiProtocol apiProtocol, ManagedChannel grpcManagedChannel) {
